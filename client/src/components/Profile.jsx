      ...
      <div className="p-4">
        ...
        <div className="flex flex-col gap-4">
          <div className="bg-brown pt-4 rounded-lg">
            <h2 className='text-2xl font-bold text-white px-8 leading-6'>Favorite Recipes</h2>
            <RecipeResults recipes={favorites} message='No favorite recipes saved yet. Go to a recipe page to add it to your favorites!' />
          </div>
          <div className="bg-brown pt-4 rounded-lg">
            <h2 className='text-2xl font-bold text-white px-8 leading-6'>Uploaded Recipes</h2>
            <RecipeResults recipes={uploaded} message='No uploaded recipes yet. Click on the button in the user card above to upload your first recipe!'/>
          </div>
        </div>
